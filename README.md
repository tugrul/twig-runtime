...
```typescript
import { getRuntime } from 'twig-runtime';
...
See [twig-transpiler](https://github.com/example/twig-transpiler) for a reference implementation.
...
```typescript
import { TwigTemplate } from 'twig-runtime';
